...
//  
//
//  Created by Ido Rabin on 11/01/2021.
...
@objc protocol MVPBindable : AnyObject {
...
fileprivate let dlog : DSLogger? = DLog.ui["MVPVCBinder"]
//typealias MVPindingTriple = (vc:NSViewController.Type, view:Any, presenter:Presenter.Type)

/// The class is a "factory" of mvp bindings betweeen NSViewControllers, Views and Presenters
...
class MVPVCBinder /*routing*/ {
    ...
    static func bindOnInitIfPossible(viewController:NSViewController) {
    ...
    static func loadVCForId(storyboard:AppStoryboard, id:String)->NSViewController? {
        return storyboard.instantiateViewController(id: id)
    }
    
    static func loadWCForId(storyboard:AppStoryboard, id:String)->NSWindowController? {
        return storyboard.instantiateWindowController(id: id)
    }
}

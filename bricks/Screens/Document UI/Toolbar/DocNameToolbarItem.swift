...
fileprivate let dlog : DSLogger? = DLog.forClass("DocNameToolbarItem")
class MNToolbarComplexView : MNColoredView {

}

class DocNameToolbarItem : MNToolbarItem {
    let IMAGE_SIZE : CGFloat = 26
    
//    var button : MNButton {
//        return self.view as! MNButton
//    }
